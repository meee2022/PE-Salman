...
export function SearchSelect({ label, value, onSelect, options, placeholder, required }: {
  label: string;
  value: string;
          ...
          <div className="absolute z-20 mt-1 w-full bg-white border border-[#E7E1D6] rounded-xl shadow-xl overflow-hidden">
            <div className="p-2 border-b border-[#F1ECE2]">
              <div className="relative">
                ...
                <input autoFocus value={q} onChange={(e) => setQ(e.target.value)} placeholder="ابحث عن المدرسة..."
